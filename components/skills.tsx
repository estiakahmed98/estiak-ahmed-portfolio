...
export default function Skills() {
  ...
  const skillIcons = [
    ...
    { name: "Angular", icon: "/icon/angular.png" },
    { name: "Redux", icon: "/icon/redux.png" },
    { name: "Jest", icon: "/icon/Jest.png" },
    { name: "Git", icon: "/icon/Git.png" },
    { name: "SEO", icon: "/icon/SEO.png" },
    { name: "PostgreSQL", icon: "/icon/postgresql-icon.png" },
    { name: "WordPress", icon: "/icon/wordpress.png" },
    { name: "AI prompt Engineering", icon: "/icon/ai-technology.png" },
    {
      name: "Data Stucture & Algorithom",
      icon: "/icon/hierarchical-structure.png",
    },
  ];
