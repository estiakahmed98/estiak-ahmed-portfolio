...
const projects: Project[] = [
  {
    ...
    image: "/assets/net-reputation.png",
    link: "https://netreptask.com/",
  },
  {
    ...
    link: "https://www.bmdcl17.com/",
  },
  {
    title: "Hilful Fuzul — Book Shop",
    description:
      "A full-featured multilingual Next.js bookshop with admin tools, product management, and order workflows.",
    longDescription:
      "Hilful Fuzul is a Next.js (App Router) + TypeScript e-commerce platform tailored for books and publishers. It includes role-based admin interfaces for managing products, writers, publishers, and orders; a customer-facing storefront with category browsing, search, cart and wishlist; and a checkout flow with payment processing. The app uses Prisma with PostgreSQL for persistence, NextAuth for authentication, file uploads for book assets, PDF viewing/exports for book previews and invoices, and contextual React providers for cart and wishlist state. The admin area contains dashboards and management UIs for products, categories, writers, publishers, and orders, plus utilities for uploads and batch operations. The UI is built with Tailwind CSS and componentized controls, with toast notifications and responsive support. Designed for deployment on modern hosting platforms (Vercel, etc.), it’s optimized for performance and extensibility.",
    technologies: [
      "Next.js (App Router)",
      "React",
      "TypeScript",
      ...
      "Tailwind CSS",
      "Stripe (payments)",
      "html2pdf.js / PDF viewer",
      "Sonner (toasts)",
      "React Context API (Cart/Wishlist)",
      "SWR / fetch (client-side data)",
      "File upload APIs",
      "Vercel / modern hosting",
      "Google Calendar integration",
    ],
    image: "/assets/Hilful-Fuzul.png",
    link: "https://hilfulfujulbd.com/kitabghor",
  },
  {
    title: "Islami Dawa Institute",
    description:
      "A multilingual Next.js platform for managing dawah activities, reports, and admin workflows.",
    longDescription:
      "Islami Dawah is a Next.js (App Router) + TypeScript application for coordinating and reporting Islamic outreach activities. It features role-based dashboards (admin, dayi/ambassador, assistant, and user), rich editor support for detailed reports, PDF export, task and weekly-plan management, email notifications, and i18n for Bengali/English. The UI uses Tailwind CSS and a component library; data persistence is powered by Prisma/Postgres. The app includes optimized admin APIs, batched comparison endpoints, and utilities for exporting reports as PDFs. Designed for deployment on Vercel.",
    technologies: [
      "Next.js",
      "React",
      "TypeScript",
    ...
    link: "https://hisab.hilfulfujulbd.com/bn",
  },
  {
